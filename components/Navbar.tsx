        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            ...
            <div className="hidden sm:ms-8 sm:flex sm:space-x-8 sm:space-x-reverse">
              <Link
                href="/"
                className="border-transparent text-stone-500 hover:border-green-500 hover:text-green-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium"
              >
                {t.navbar.home}
              </Link>
              <Link
      ...
      >
        <div className="pt-2 pb-3 space-y-1">
          <Link
            ...
            className="bg-green-50 border-green-500 text-green-700 block ps-3 pe-4 py-2 border-s-4 text-base font-medium"
          >
            {t.navbar.home}
          </Link>
          <Link
            href="/initiatives"
            onClick={() => setIsOpen(false)}
            className="border-transparent text-stone-500 hover:bg-stone-50 hover:border-stone-300 hover:text-stone-700 block ps-3 pe-4 py-2 border-s-4 text-base font-medium"
          >
            {t.navbar.initiatives}
          </Link>
          <a
