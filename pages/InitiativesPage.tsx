...
const MOCK_INITIATIVES: Initiative[] = [
  {
    ...
    description: 'Planting the national tree of the UAE, known for its drought resistance and cultural significance.',
  ...
  },
  {
    ...
    description: 'Supporting sustainable agriculture by planting olive trees in the northern highlands.',
    region: 'Al Jouf, KSA',
    price: 35,
  ...
  },
  {
    ...
    description: 'Planting Neem trees in city centers to reduce urban heat islands.',
    region: 'Riyadh, KSA',
    price: 45,
  ...
  },
  {
    ...
    description: 'Planting Sidr trees for honey production and ecosystem support.',
    region: 'Hatta, Dubai',
    price: 60,
    ...
    <div className="bg-stone-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-3xl font-extrabold text-stone-900 sm:text-4xl">{t.initiatives.heading}</h2>
        ...
        <div className="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {MOCK_INITIATIVES.map((initiative) => (
            <div key={initiative.id} className="flex flex-col bg-white rounded-xl shadow-sm hover:shadow-lg transition-shadow overflow-hidden border border-stone-100">
              <div className="flex-shrink-0 relative">
                <img className="h-48 w-full object-cover" src={initiative.imageUrl} alt={initiative.title} />
              ...
              <div className="flex-1 p-6 flex flex-col justify-between">
                ...
                <div className="mt-6">
                  ...
                  <div className="w-full bg-stone-200 rounded-full h-2.5 mb-4">
                    <div className="bg-green-600 h-2.5 rounded-full rtl:rounded-r-full rtl:rounded-l-none" style={{ width: `${initiative.progress}%` }}></div>
                  </div>
                  
                  <div className="flex items-center justify-between">
                    <span className="text-2xl font-bold text-stone-900">${initiative.price}</span>
                    <button className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                      {t.initiatives.plantNow} <Sprout className="ms-2 -me-1 h-4 w-4" />
                    </button>
                  </div>
                </div>
              </div>
